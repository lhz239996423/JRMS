...
<html>
    ...
    <body class="bgp" style="height:100vh;">
        <table align="center">
            ...
            <tr>
                <td >
                    <form action="http://localhost:8080/JRMS/RegisterServlet" method="post">
                        <table border="2" cellspacing="0" cellpadding="0" width="400" align="center">
                            <tr align="center">
                                <td width="110">
                                    登录名字
                                </td>
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <input type="password" name="password1" size="28"/>
                                </td>
                            </tr>
                            <tr align="center">
                                <td>
